...
<head>
  ...
  include ("../../Modelo/Productos/registro.php"); 
...
<body>
  ...
  <div class="ingresar">
    ...
    <a href="Modificacion.php">¿Desea modificar algun producto?</a>
    <input type="submit" value="Registrar" id="Ingresar" name ="Registrar">
</form>
